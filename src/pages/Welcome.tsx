        ...
        <div className="flex flex-col gap-5 w-full max-w-lg">
          ...
          {auth && Object.keys(auth).length > 0 && (
            <div className="flex flex-col gap-2">
              ...
              <button
                type="button"
                className="flex p-3 rounded border-1 border-stone-200 bg-stone-50 w-full flex-col gap-1 hover:bg-stone-200 cursor-pointer transition-colors text-start"
              ...
              <div className="flex mt-2 items-center justify-center text-stone-300 gap-5">
